...
//#endregion
//#region node_modules/@mantine/core/esm/core/utils/use-hovered/use-hovered.mjs
function useHovered() {
...
//#endregion
//#region node_modules/@mantine/hooks/esm/utils/clamp/clamp.mjs
...
//#endregion
//#region node_modules/@mantine/hooks/esm/utils/shallow-equal/shallow-equal.mjs
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-clipboard/use-clipboard.mjs
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-window-event/use-window-event.mjs
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-pagination/use-pagination.mjs
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-resize-observer/use-resize-observer.mjs
var defaultState = {
	x: 0,
	y: 0,
	width: 0,
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-shallow-effect/use-shallow-effect.mjs
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-timeout/use-timeout.mjs
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-mutation-observer/use-mutation-observer.mjs
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-mounted/use-mounted.mjs
function useMounted() {
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-radial-move/use-radial-move.mjs
...
function normalizeRadialValue(degree, step) {
	const clamped = clamp$3(degree, 0, 360);
...
//#endregion
//#region node_modules/@mantine/hooks/esm/use-scroll-spy/use-scroll-spy.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/core/utils/create-use-external-events/create-use-external-events.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/core/utils/get-env/get-env.mjs
function getEnv() {
	if (typeof process !== "undefined" && process.env && "development") return "development";
	return "development";
}
//#endregion
//#region node_modules/@mantine/core/esm/core/utils/memoize/memoize.mjs
...
function resolveStyles({ theme, styles, props, stylesCtx }) {
	return (Array.isArray(styles) ? styles : [styles]).reduce((acc, style) => {
...
//#endregion
//#region node_modules/@mantine/core/esm/core/MantineProvider/color-functions/colors-tuple/colors-tuple.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/core/MantineProvider/color-functions/lighten/lighten.mjs
function lighten(color, alpha) {
	if (color.startsWith("var(")) return `color-mix(in srgb, ${color}, white ${alpha * 100}%)`;
	const { r, g, b, a } = toRgba(color);
...
//#endregion
//#region node_modules/@mantine/core/esm/core/MantineProvider/use-mantine-color-scheme/use-computed-color-scheme.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/core/MantineProvider/ColorSchemeScript/ColorSchemeScript.mjs
var getScript = ({ defaultColorScheme, localStorageKey, forceColorScheme }) => forceColorScheme ? `document.documentElement.setAttribute("data-mantine-color-scheme", '${forceColorScheme}');` : `try {
...
//#endregion
//#region node_modules/@mantine/core/esm/core/MantineProvider/merge-theme-overrides/merge-theme-overrides.mjs
function mergeThemeOverrides(...overrides) {
	return overrides.reduce((acc, override) => deepMerge(acc, override), {});
}
//#endregion
//#region node_modules/@mantine/core/esm/core/MantineProvider/use-matches/use-matches.mjs
var BREAKPOINTS = [
	"xs",
	"sm",
	"md",
...
//#endregion
//#region node_modules/@mantine/core/esm/core/MantineProvider/mantine-html-props.mjs
...
var _Box = (0, import_react.forwardRef)(({ component, style, __vars, className, variant, mod, size, hiddenFrom, visibleFrom, lightHidden, darkHidden, renderRoot, __size, ...others }, ref) => {
	const theme = useMantineTheme();
...
function DirectionProvider({ children, initialDirection = "ltr", detectDirection = true }) {
	...
	const setDirection = (0, import_react.useCallback)((direction) => {
		setDir(direction);
	...
	useMutationObserver((0, import_react.useCallback)(() => {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Collapse/use-collapse.mjs
...
function useCollapse({ transitionDuration, transitionTimingFunction = "ease", onTransitionEnd = () => {}, opened, keepMounted = false }) {
...
var Collapse = factory((props, ref) => {
	const { children, in: opened, transitionDuration, transitionTimingFunction, style, onTransitionEnd, animateOpacity, keepMounted, ...others } = useProps("Collapse", defaultProps$103, props);
	const theme = useMantineTheme();
...
var index$3 = typeof document !== "undefined" ? import_react.useLayoutEffect : function noop() {};
...
var index$2 = typeof document !== "undefined" ? import_react.useLayoutEffect : function noop() {};
...
*/
var useDelayGroupContext = () => import_react.useContext(FloatingDelayGroupContext);
/**
...
function useRole(context, props) {
	...
	const floatingId = import_react.useMemo(() => {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ScrollArea/ScrollArea.module.css.mjs
var classes$86 = {
	"root": "m_d57069b5",
	"content": "m_b1336c6",
	"viewport": "m_c0783ff9",
...
var defaultProps$102 = {
	scrollHideDelay: 1e3,
	type: "hover"
};
var ScrollAreaRoot = (0, import_react.forwardRef)((_props, ref) => {
	const { type, scrollHideDelay, scrollbars, getStyles, ...others } = useProps("ScrollAreaRoot", defaultProps$102, _props);
...
var Thumb$2 = (0, import_react.forwardRef)((props, forwardedRef) => {
	const { style, ...others } = props;
...
var ScrollAreaViewport = (0, import_react.forwardRef)(({ children, style, onWheel, ...others }, ref) => {
	const ctx = useScrollAreaContext();
...
var defaultProps$101 = {
	scrollHideDelay: 1e3,
	type: "hover",
	scrollbars: "xy"
};
var varsResolver$89 = createVarsResolver((_, { scrollbarSize, overscrollBehavior, scrollbars }) => {
...
var ScrollArea = factory((_props, ref) => {
	const props = useProps("ScrollArea", defaultProps$101, _props);
	const { classNames, className, style, styles, unstyled, scrollbarSize, vars, type, scrollHideDelay, viewportProps, viewportRef, onScrollPositionChange, children, offsetScrollbars, scrollbars, onBottomReached, onTopReached, overscrollBehavior, attributes, ...others } = props;
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollAreaViewport, {
				...
				onScroll: (e) => {
					...
					if (scrollTop - (scrollHeight - clientHeight) >= -.8) onBottomReached?.();
...
var ScrollAreaAutosize = factory((props, ref) => {
	const { children, classNames, styles, scrollbarSize, scrollHideDelay, type, dir, offsetScrollbars, overscrollBehavior, viewportRef, onScrollPositionChange, unstyled, variant, viewportProps, scrollbars, style, vars, onBottomReached, onTopReached, onOverflowChange, ...others } = useProps("ScrollAreaAutosize", defaultProps$101, props);
...
var defaultProps$100 = { __staticSelector: "UnstyledButton" };
var UnstyledButton = polymorphicFactory((_props, ref) => {
	const props = useProps("UnstyledButton", defaultProps$100, _props);
...
var varsResolver$88 = createVarsResolver((_, { radius, shadow }) => ({ root: {
...
var FloatingArrow = (0, import_react.forwardRef)(({ position, arrowSize, arrowOffset, arrowRadius, arrowPosition, visible, arrowX, arrowY, style, ...others }, ref) => {
	const { dir } = useDirection();
...
var defaultProps$99 = { zIndex: getDefaultZIndex("modal") };
var varsResolver$87 = createVarsResolver((_, { gradient, color, backgroundOpacity, blur, radius, zIndex }) => ({ root: {
...
var Overlay = polymorphicFactory((_props, ref) => {
	const props = useProps("Overlay", defaultProps$99, _props);
...
var defaultProps$98 = { reuseTargetNode: true };
var Portal = factory((props, ref) => {
	const { children, target, reuseTargetNode, ...others } = useProps("Portal", defaultProps$98, props);
	const [mounted, setMounted] = (0, import_react.useState)(false);
...
var PopoverTarget = factory((props, ref) => {
	const { children, refProp, popupType, ...others } = useProps("PopoverTarget", defaultProps$97, props);
	const child = getSingleElementChild(children);
...
var varsResolver$86 = createVarsResolver((_, { radius, shadow }) => ({ dropdown: {
	"--popover-radius": radius === void 0 ? void 0 : getRadius(radius),
	"--popover-shadow": getShadow(shadow)
} }));
function Popover(_props) {
	const props = useProps("Popover", defaultProps$96, _props);
...
var Bars = (0, import_react.forwardRef)(({ className, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, {
	component: "span",
	className: clsx(classes$80.barsLoader, className),
	...others,
	ref,
	children: [
...
var Dots = (0, import_react.forwardRef)(({ className, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, {
	component: "span",
	className: clsx(classes$80.dotsLoader, className),
	...others,
	ref,
	children: [
...
var Oval = (0, import_react.forwardRef)(({ className, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
	component: "span",
	className: clsx(classes$80.ovalLoader, className),
	...others,
	ref
}));
...
var varsResolver$85 = createVarsResolver((theme, { size, color }) => ({ root: {
	"--loader-size": getSize(size, "loader-size"),
	"--loader-color": color ? getThemeColor(color, theme) : void 0
} }));
var Loader = factory((_props, ref) => {
	const props = useProps("Loader", defaultProps$95, _props);
...
var defaultProps$94 = { orientation: "horizontal" };
var varsResolver$84 = createVarsResolver((_, { borderWidth }) => ({ group: { "--ai-border-width": rem(borderWidth) } }));
var ActionIconGroup = factory((_props, ref) => {
	const props = useProps("ActionIconGroup", defaultProps$94, _props);
	const { className, style, classNames, styles, unstyled, orientation, vars, borderWidth, variant, mod, attributes, ...others } = useProps("ActionIconGroup", defaultProps$94, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
...
var varsResolver$83 = createVarsResolver((theme, { radius, color, gradient, variant, autoContrast, size }) => {
...
var varsResolver$82 = createVarsResolver((theme, { size, radius, variant, gradient, color, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		gradient,
...
var CloseIcon = (0, import_react.forwardRef)(({ size = "var(--cb-icon-size, 70%)", style, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	viewBox: "0 0 15 15",
	fill: "none",
...
var defaultProps$93 = { variant: "subtle" };
var varsResolver$81 = createVarsResolver((_, { size, radius, iconSize }) => ({ root: {
...
var CloseButton = polymorphicFactory((_props, ref) => {
	const props = useProps("CloseButton", defaultProps$93, _props);
...
var varsResolver$80 = createVarsResolver((_, { grow, preventGrowOverflow, gap, align, justify, wrap }, { childWidth }) => ({ root: {
...
var Group = factory((_props, ref) => {
	const props = useProps("Group", defaultProps$92, _props);
...
var ModalBase = (0, import_react.forwardRef)(({ keepMounted, opened, onClose, id, transitionProps, onExitTransitionEnd, onEnterTransitionEnd, trapFocus, closeOnEscape, returnFocus, closeOnClickOutside, withinPortal, portalProps, lockScroll, children, zIndex, shadow, padding, __vars, unstyled, removeScrollProps, ...others }, ref) => {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ModalBase/ModalBase.module.css.mjs
var classes$76 = {
	"title": "m_615af6c9",
	"header": "m_b5489c3c",
	"inner": "m_60c222c7",
...
var ModalBaseBody = (0, import_react.forwardRef)(({ className, ...others }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...
		...others,
		id: bodyId,
		className: clsx({ [classes$76.body]: !ctx.unstyled }, className)
	});
});
...
var ModalBaseCloseButton = (0, import_react.forwardRef)(({ className, onClick, ...others }, ref) => {
	const ctx = useModalBaseContext();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloseButton, {
		...
		className: clsx({ [classes$76.close]: !ctx.unstyled }, className),
...
var ModalBaseContent = (0, import_react.forwardRef)(({ transitionProps, className, innerProps, onKeyDown, style, ...others }, ref) => {
	const ctx = useModalBaseContext();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Transition, {
		...
		children: (transitionStyles) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...innerProps,
			className: clsx({ [classes$76.inner]: !ctx.unstyled }, innerProps.className),
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusTrap, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Paper, {
					...
					className: clsx({ [classes$76.content]: !ctx.unstyled }, className),
					unstyled: ctx.unstyled,
...
var ModalBaseHeader = (0, import_react.forwardRef)(({ className, ...others }, ref) => {
	const ctx = useModalBaseContext();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		component: "header",
		ref,
		className: clsx({ [classes$76.header]: !ctx.unstyled }, className),
		...others
	});
});
...
var ModalBaseOverlay = (0, import_react.forwardRef)(({ onClick, transitionProps, style, visible, ...others }, ref) => {
	const ctx = useModalBaseContext();
...
var ModalBaseTitle = (0, import_react.forwardRef)(({ className, ...others }, ref) => {
	const id = useModalTitle();
	const ctx = useModalBaseContext();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		component: "h2",
		ref,
		className: clsx({ [classes$76.title]: !ctx.unstyled }, className),
		...others,
		id
	});
});
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Input/Input.module.css.mjs
var classes$75 = {
	"wrapper": "m_6c018570",
	"input": "m_8fb7ebe7",
	"section": "m_82577fc2",
...
function InputClearSection({ __clearable, __clearSection, rightSection, __defaultRightSection, size = "sm" }) {
	...
	if (clearSection && (rightSection || __defaultRightSection)) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		style: {
			...
			gap: 2,
			alignItems: "center",
			paddingInlineEnd: clearSectionOffset$1[size]
		},
...
var varsResolver$79 = createVarsResolver((_, { size }) => ({ description: { "--input-description-size": size === void 0 ? void 0 : `calc(${getFontSize(size)} - ${rem(2)})` } }));
var InputDescription = factory((_props, ref) => {
	const props = useProps("InputDescription", null, _props);
	const { classNames, className, style, styles, unstyled, vars, size, __staticSelector, __inheritStyles = true, attributes, variant, ...others } = useProps("InputDescription", null, props);
...
var varsResolver$78 = createVarsResolver((_, { size }) => ({ error: { "--input-error-size": size === void 0 ? void 0 : `calc(${getFontSize(size)} - ${rem(2)})` } }));
...
var defaultProps$91 = { labelElement: "label" };
var varsResolver$77 = createVarsResolver((_, { size }) => ({ label: {
	"--input-label-size": getFontSize(size),
	"--input-asterisk-color": void 0
} }));
var InputLabel = factory((_props, ref) => {
	const props = useProps("InputLabel", defaultProps$91, _props);
	const { classNames, className, style, styles, unstyled, vars, labelElement, size, required, htmlFor, onMouseDown, children, __staticSelector, variant, mod, attributes, ...others } = useProps("InputLabel", defaultProps$91, props);
	const _getStyles = useStyles({
		name: ["InputWrapper", __staticSelector],
		props,
		classes: classes$75,
...
var varsResolver$76 = createVarsResolver((_, { size }) => ({
	label: {
		"--input-label-size": getFontSize(size),
		"--input-asterisk-color": void 0
	},
...
var InputWrapper = factory((_props, ref) => {
	const props = useProps("InputWrapper", defaultProps$90, _props);
...
var varsResolver$75 = createVarsResolver((_, props, ctx) => ({ wrapper: {
...
var Input = polymorphicFactory((_props, ref) => {
	const props = useProps("Input", defaultProps$89, _props);
...
var InputBase = polymorphicFactory((props, ref) => {
	const { inputProps, wrapperProps, ...others } = useInputProps("InputBase", defaultProps$88, props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Flex/Flex.module.css.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/FloatingIndicator/FloatingIndicator.module.css.mjs
var classes$73 = { "root": "m_96b553a6" };
//#endregion
//#region node_modules/@mantine/core/esm/components/FloatingIndicator/use-floating-indicator.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/FloatingIndicator/FloatingIndicator.mjs
var varsResolver$74 = createVarsResolver((_theme, { transitionDuration }) => ({ root: { "--transition-duration": typeof transitionDuration === "number" ? `${transitionDuration}ms` : transitionDuration } }));
var FloatingIndicator = factory((_props, ref) => {
	const props = useProps("FloatingIndicator", null, _props);
	const { classNames, className, style, styles, unstyled, vars, target, parent, transitionDuration, mod, displayAfterTransitionEnd, attributes, ...others } = props;
	const getStyles = useStyles({
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Accordion/Accordion.module.css.mjs
var classes$72 = {
	"root": "m_9bdbb667",
	"panel": "m_df78851f",
	"content": "m_4ba554d4",
...
var varsResolver$73 = createVarsResolver((_, { transitionDuration, chevronSize, radius }) => ({ root: {
...
function Accordion(_props) {
	const props = useProps("Accordion", defaultProps$87, _props);
	const { classNames, className, style, styles, unstyled, vars, children, multiple, value, defaultValue, onChange, id, loop, transitionDuration, disableChevronRotation, chevronPosition, chevronSize, order, chevron, variant, radius, chevronIconSize, attributes, ...others } = props;
	const uid = useId$3(id);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Affix/Affix.module.css.mjs
var classes$71 = { "root": "m_7f854edf" };
//#endregion
//#region node_modules/@mantine/core/esm/components/Affix/Affix.mjs
var defaultProps$86 = {
	position: {
		bottom: 0,
		right: 0
...
var varsResolver$72 = createVarsResolver((_, { zIndex, position }) => ({ root: {
...
var Affix = factory((_props, ref) => {
	const props = useProps("Affix", defaultProps$86, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Alert/Alert.module.css.mjs
var classes$70 = {
	"root": "m_66836ed3",
	"wrapper": "m_a5d60502",
	"body": "m_667c2793",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Alert/Alert.mjs
var varsResolver$71 = createVarsResolver((theme, { radius, color, variant, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
...
var defaultProps$85 = { inherit: false };
var varsResolver$70 = createVarsResolver((theme, { variant, lineClamp, gradient, size, color }) => ({ root: {
...
var Text = polymorphicFactory((_props, ref) => {
	const props = useProps("Text", defaultProps$85, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Anchor/Anchor.module.css.mjs
var classes$68 = { "root": "m_849cf0da" };
//#endregion
//#region node_modules/@mantine/core/esm/components/Anchor/Anchor.mjs
var defaultProps$84 = { underline: "hover" };
var Anchor = polymorphicFactory((props, ref) => {
	const { underline, className, unstyled, mod, ...others } = useProps("Anchor", defaultProps$84, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
		component: "a",
		ref,
		className: clsx({ [classes$68.root]: !unstyled }, className),
		...others,
		mod: [{ underline }, mod],
...
//#endregion
//#region node_modules/@mantine/core/esm/components/AngleSlider/AngleSlider.module.css.mjs
var classes$67 = {
	"root": "m_48204f9b",
	"marks": "m_bb9cdbad",
	"mark": "m_481dd586",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/AngleSlider/AngleSlider.mjs
var defaultProps$83 = {
	step: 1,
	withLabel: true
};
var varsResolver$69 = createVarsResolver((_, { size, thumbSize }) => ({ root: {
	"--slider-size": rem(size),
	"--thumb-size": rem(thumbSize)
} }));
var AngleSlider = factory((_props, ref) => {
	const props = useProps("AngleSlider", defaultProps$83, _props);
	const { classNames, className, style, styles, unstyled, vars, step, value, defaultValue, onChange, onMouseDown, withLabel, marks, thumbSize, restrictToMarks, formatLabel, onChangeEnd, disabled, onTouchStart, name, hiddenInputProps, "aria-label": ariaLabel, tabIndex, onScrubStart, onScrubEnd, mod, attributes, ...others } = props;
	...
	const update = (val) => {
		if (rootRef.current && !disabled) setValue(restrictToMarks && Array.isArray(marks) ? findClosestNumber(val, marks.map((mark) => mark.value)) : val);
	};
	...
	const marksItems = marks?.map((mark, index) => /* @__PURE__ */ (0, import_react.createElement)("div", {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/AppShell/AppShell.module.css.mjs
var classes$66 = {
	"root": "m_89ab340",
	"navbar": "m_45252eee",
	"aside": "m_9cdde9a",
...
var varsResolver$68 = createVarsResolver((_, { transitionDuration, transitionTimingFunction }) => ({ root: {
...
var AppShell = factory((_props, ref) => {
	const props = useProps("AppShell", defaultProps$82, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/AspectRatio/AspectRatio.module.css.mjs
var classes$65 = { "root": "m_71ac47fc" };
//#endregion
//#region node_modules/@mantine/core/esm/components/AspectRatio/AspectRatio.mjs
var varsResolver$67 = createVarsResolver((_, { ratio }) => ({ root: { "--ar-ratio": ratio?.toString() } }));
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Combobox/Combobox.module.css.mjs
var classes$64 = {
	"dropdown": "m_88b62a41",
	"search": "m_985517d8",
	"options": "m_b2821a6e",
...
var defaultProps$81 = { error: null };
var varsResolver$66 = createVarsResolver((theme, { size, color }) => ({ chevron: {
...
var ComboboxChevron = factory((_props, ref) => {
	const props = useProps("ComboboxChevron", defaultProps$81, _props);
...
ComboboxChevron.classes = classes$64;
...
var ComboboxClearButton = (0, import_react.forwardRef)(({ size, onMouseDown, onClick, onClear, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input.ClearButton, {
	ref,
	tabIndex: -1,
	"aria-hidden": true,
	...others,
...
ComboboxEmpty.classes = classes$64;
...
var ComboboxEventsTarget = factory((props, ref) => {
	const { children, refProp, withKeyboardNavigation, withAriaAttributes, withExpandedAttribute, targetType, autoComplete, ...others } = useProps("ComboboxEventsTarget", defaultProps$79, props);
	const child = getSingleElementChild(children);
...
ComboboxFooter.classes = classes$64;
...
ComboboxGroup.classes = classes$64;
...
ComboboxHeader.classes = classes$64;
...
ComboboxOption.classes = classes$64;
...
ComboboxOptions.classes = classes$64;
...
var ComboboxSearch = factory((_props, ref) => {
	const { classNames, styles, unstyled, vars, withAriaAttributes, onKeyDown, withKeyboardNavigation, size, ...others } = useProps("ComboboxSearch", defaultProps$78, _props);
	const ctx = useComboboxContext();
...
ComboboxSearch.classes = classes$64;
...
var ComboboxTarget = factory((props, ref) => {
	const { children, refProp, withKeyboardNavigation, withAriaAttributes, withExpandedAttribute, targetType, autoComplete, ...others } = useProps("ComboboxTarget", defaultProps$77, props);
	const child = getSingleElementChild(children);
...
function useCombobox({ defaultOpened, opened, onOpenedChange, onDropdownClose, onDropdownOpen, loop = true, scrollBehavior = "instant" } = {}) {
	...
	const selectNextOption = (0, import_react.useCallback)(() => {
		...
		return selectOption(getNextIndex$1(selectedOptionIndex.current, items, loop));
	}, [selectOption, loop]);
	const selectPreviousOption = (0, import_react.useCallback)(() => {
		const root = getRootElement(targetRef.current);
		const items = findElementsBySelector(`#${listId.current} [data-combobox-option]`, root);
		return selectOption(getPreviousIndex$1(selectedOptionIndex.current, items, loop));
	}, [selectOption, loop]);
	const selectFirstOption = (0, import_react.useCallback)(() => {
		const root = getRootElement(targetRef.current);
		return selectOption(getFirstIndex$1(findElementsBySelector(`#${listId.current} [data-combobox-option]`, root)));
	}, [selectOption]);
...
var varsResolver$65 = createVarsResolver((_, { size, dropdownPadding }) => ({
	options: {
...
function Combobox(_props) {
	const props = useProps("Combobox", defaultProps$76, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/utils/InlineInput/InlineInput.module.css.mjs
var classes$63 = {
	"root": "m_5f75b09e",
	"body": "m_5f6e695e",
...
var InlineInputClasses = classes$63;
var InlineInput = (0, import_react.forwardRef)(({ __staticSelector, __stylesApiProps, className, classNames, styles, unstyled, children, label, description, id, disabled, error, size, labelPosition = "left", bodyElement = "div", labelElement = "label", variant, style, vars, mod, attributes, ...others }, ref) => {
	const getStyles = useStyles({
		name: __staticSelector,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Checkbox/Checkbox.module.css.mjs
var classes$62 = {
	"root": "m_bf2d988c",
	"inner": "m_26062bec",
	"input": "m_26063560",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Checkbox/CheckboxGroup.context.mjs
var CheckboxGroupContext = (0, import_react.createContext)(null);
var CheckboxGroupProvider = CheckboxGroupContext.Provider;
var useCheckboxGroupContext = () => (0, import_react.useContext)(CheckboxGroupContext);
//#endregion
//#region node_modules/@mantine/core/esm/components/Checkbox/CheckboxCard/CheckboxCard.context.mjs
var [CheckboxCardProvider, useCheckboxCardContext] = createOptionalContext();
//#endregion
//#region node_modules/@mantine/core/esm/components/Checkbox/CheckboxCard/CheckboxCard.module.css.mjs
var classes$61 = { "card": "m_26775b0a" };
//#endregion
//#region node_modules/@mantine/core/esm/components/Checkbox/CheckboxCard/CheckboxCard.mjs
var defaultProps$75 = { withBorder: true };
var varsResolver$64 = createVarsResolver((_, { radius }) => ({ card: { "--card-radius": getRadius(radius) } }));
var CheckboxCard = factory((_props, ref) => {
	const props = useProps("CheckboxCard", defaultProps$75, _props);
...
CheckboxCard.classes = classes$61;
//#endregion
...
var CheckboxGroup = factory((props, ref) => {
	const { value, defaultValue, onChange, size, wrapperProps, children, readOnly, disabled, ...others } = useProps("CheckboxGroup", null, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: [],
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Checkbox/CheckboxIndicator/CheckboxIndicator.module.css.mjs
var classes$60 = {
...
var varsResolver$63 = createVarsResolver((theme, { radius, color, size, iconColor, variant, autoContrast }) => {
	const parsedColor = parseThemeColor({
		color: color || theme.primaryColor,
		theme
	});
...
var CheckboxIndicator = factory((_props, ref) => {
	const props = useProps("CheckboxIndicator", defaultProps$74, _props);
...
CheckboxIndicator.classes = classes$60;
//#endregion
...
var varsResolver$62 = createVarsResolver((theme, { radius, color, size, iconColor, variant, autoContrast }) => {
	const parsedColor = parseThemeColor({
		color: color || theme.primaryColor,
		theme
	});
...
var Checkbox = factory((_props, forwardedRef) => {
	const props = useProps("Checkbox", defaultProps$73, _props);
	const { classNames, className, style, styles, unstyled, vars, color, label, id, size, radius, wrapperProps, checked, labelPosition, description, error, disabled, variant, indeterminate, icon: Icon, rootRef, iconColor, onChange, autoContrast, mod, attributes, ...others } = props;
	const ctx = useCheckboxGroupContext();
	...
	(0, import_react.useEffect)(() => {
		if (ref && "current" in ref && ref.current) {
			...
			if (indeterminate) ref.current.setAttribute("data-indeterminate", "true");
			else ref.current.removeAttribute("data-indeterminate");
		}
	}, [indeterminate, ref]);
...
function Option({ data, withCheckIcon, withAlignedLabels, value, checkIconPosition, unstyled, renderOption }) {
	if (!isOptionsGroup(data)) {
		...
		const check = withCheckIcon && (checked ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckIcon, { className: classes$64.optionsDropdownCheckIcon }) : withAlignedLabels ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: classes$64.optionsDropdownCheckPlaceholder }) : null);
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Combobox.Option, {
			...
			className: clsx({ [classes$64.optionsDropdownOption]: !unstyled }),
...
function useAvatarGroupContext() {
	return { withinGroup: !!(0, import_react.useContext)(AvatarGroupContext) };
}
//#endregion
//#region node_modules/@mantine/core/esm/components/Avatar/AvatarGroup/AvatarGroup.mjs
var varsResolver$61 = createVarsResolver((_, { spacing }) => ({ group: { "--ag-spacing": getSpacing(spacing) } }));
...
var varsResolver$60 = createVarsResolver((theme, { size, radius, variant, gradient, color, autoContrast, name, allowedInitialsColors }) => {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/BackgroundImage/BackgroundImage.module.css.mjs
var classes$58 = { "root": "m_2ce0de02" };
//#endregion
//#region node_modules/@mantine/core/esm/components/BackgroundImage/BackgroundImage.mjs
var varsResolver$59 = createVarsResolver((_, { radius }) => ({ root: { "--bi-radius": radius === void 0 ? void 0 : getRadius(radius) } }));
...
var varsResolver$58 = createVarsResolver((theme, { radius, color, gradient, variant, size, autoContrast, circle }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		gradient,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Blockquote/Blockquote.module.css.mjs
var classes$56 = {
	"root": "m_ddec01c0",
	"icon": "m_dde7bd57",
	"cite": "m_dde51a35"
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Blockquote/Blockquote.mjs
var defaultProps$72 = { iconSize: 48 };
var varsResolver$57 = createVarsResolver((theme, { color, iconSize, radius }) => {
...
var Blockquote = factory((_props, ref) => {
	const props = useProps("Blockquote", defaultProps$72, _props);
	const { classNames, className, style, styles, unstyled, vars, children, icon, iconSize, cite, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "Blockquote",
		classes: classes$56,
		props,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Breadcrumbs/Breadcrumbs.module.css.mjs
var classes$55 = {
	"root": "m_8b3717df",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Breadcrumbs/Breadcrumbs.mjs
var defaultProps$71 = { separator: "/" };
var varsResolver$56 = createVarsResolver((_, { separatorMargin }) => ({ root: { "--bc-separator-margin": getSpacing(separatorMargin) } }));
var Breadcrumbs = factory((_props, ref) => {
	const props = useProps("Breadcrumbs", defaultProps$71, _props);
	...
	const items = import_react.Children.toArray(children).reduce((acc, child, index, array) => {
		...
		acc.push(item);
		if (index !== array.length - 1) acc.push(/* @__PURE__ */ (0, import_react.createElement)(Box, {
			...getStyles("separator"),
			key: `separator-${index}`
		}, separator));
		return acc;
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Burger/Burger.module.css.mjs
var classes$54 = {
	"root": "m_fea6bf1a",
	"burger": "m_d4fb9cad"
};
...
var varsResolver$55 = createVarsResolver((theme, { color, size, lineSize, transitionDuration, transitionTimingFunction }) => ({ root: {
...
var defaultProps$70 = { orientation: "horizontal" };
var varsResolver$54 = createVarsResolver((_, { borderWidth }) => ({ group: { "--button-border-width": rem(borderWidth) } }));
var ButtonGroup = factory((_props, ref) => {
	const props = useProps("ButtonGroup", defaultProps$70, _props);
	const { className, style, classNames, styles, unstyled, orientation, vars, borderWidth, variant, mod, attributes, ...others } = useProps("ButtonGroup", defaultProps$70, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		...useStyles({
			name: "ButtonGroup",
			props,
...
var varsResolver$53 = createVarsResolver((theme, { radius, color, gradient, variant, autoContrast, size }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		gradient,
...
var varsResolver$52 = createVarsResolver((theme, { radius, color, gradient, variant, size, justify, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		gradient,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Card/Card.module.css.mjs
var classes$52 = {
	"root": "m_e615b15f",
	"section": "m_599a2148"
};
...
var varsResolver$51 = createVarsResolver((_, { padding }) => ({ root: { "--card-padding": getSpacing(padding) } }));
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Center/Center.module.css.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Chip/Chip.mjs
var defaultProps$69 = { type: "checkbox" };
var varsResolver$50 = createVarsResolver((theme, { size, radius, variant, color, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		variant: variant || "filled",
...
var Chip = factory((_props, ref) => {
	const props = useProps("Chip", defaultProps$69, _props);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
			...
			children: [_checked && icon !== null && icon !== false && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...getStyles("iconWrapper"),
				children: icon === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckIcon, { ...getStyles("checkIcon") }) : icon
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Code/Code.module.css.mjs
var classes$49 = { "root": "m_b183c0a2" };
//#endregion
//#region node_modules/@mantine/core/esm/components/Code/Code.mjs
var varsResolver$49 = createVarsResolver((theme, { color }) => ({ root: { "--code-bg": color ? getThemeColor(color, theme) : void 0 } }));
var Code = factory((_props, ref) => {
	const props = useProps("Code", null, _props);
	const { classNames, className, style, styles, unstyled, vars, color, block, variant, mod, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "Code",
		props,
		classes: classes$49,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorSwatch/ColorSwatch.module.css.mjs
var classes$48 = {
	"root": "m_de3d2490",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorSwatch/ColorSwatch.mjs
var defaultProps$68 = { withShadow: true };
var varsResolver$48 = createVarsResolver((_, { radius, size }) => ({ root: {
	"--cs-radius": radius === void 0 ? void 0 : getRadius(radius),
	"--cs-size": rem(size)
} }));
var ColorSwatch = polymorphicFactory((_props, ref) => {
	const props = useProps("ColorSwatch", defaultProps$68, _props);
	const { classNames, className, style, styles, unstyled, vars, color, size, radius, withShadow, children, variant, attributes, ...others } = useProps("ColorSwatch", defaultProps$68, props);
	const getStyles = useStyles({
		name: "ColorSwatch",
		props,
		classes: classes$48,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, {
		...
		...others,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { ...getStyles("alphaOverlay") }),
			withShadow && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { ...getStyles("shadowOverlay") }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { ...getStyles("colorOverlay", { style: { backgroundColor: color } }) }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorPicker/ColorPicker.context.mjs
var [ColorPickerProvider, useColorPickerContext] = createOptionalContext(null);
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorPicker/ColorPicker.module.css.mjs
var classes$47 = {
	"wrapper": "m_fee9c77",
	"preview": "m_9dddfbac",
	"body": "m_bffecc3e",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorPicker/Thumb/Thumb.mjs
var Thumb$1 = (0, import_react.forwardRef)(({ position, ...others }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
	ref,
	__vars: {
...
var ColorSlider = factory((_props, ref) => {
	...
	const { classNames, className, style, styles, unstyled, vars, onChange, onChangeEnd, maxValue, round, size = "md", focusable = true, value, overlays, thumbColor = "transparent", onScrubStart, onScrubEnd, __staticSelector = "ColorPicker", attributes, ...others } = props;
	const _getStyles = useStyles({
		name: __staticSelector,
		classes: classes$47,
		props,
	...
	const getStyles = useColorPickerContext()?.getStyles || _getStyles;
	const theme = useMantineTheme();
	...
	const layers = overlays.map((overlay, index) => /* @__PURE__ */ (0, import_react.createElement)("div", {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorPicker/converters/parsers.mjs
...
var AlphaSlider = (0, import_react.forwardRef)((props, ref) => {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorPicker/converters/converters.mjs
...
function hsvaToRgba(color, includeAlpha) {
	...
	if (!includeAlpha) return `rgb(${r}, ${g}, ${b})`;
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorPicker/Saturation/Saturation.mjs
function Saturation({ className, onChange, onChangeEnd, value, saturationLabel, focusable = true, size, color, onScrubStart, onScrubEnd, ...others }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, {
		...
		onKeyDown: handleKeyDown,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...getStyles("saturationOverlay", { style: { backgroundColor: `hsl(${value.h}, 100%, 50%)` } }) }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...getStyles("saturationOverlay", { style: { backgroundImage: "linear-gradient(90deg, #fff, transparent)" } }) }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ...getStyles("saturationOverlay", { style: { backgroundImage: "linear-gradient(0deg, #000, transparent)" } }) }),
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorPicker/Swatches/Swatches.mjs
var Swatches = (0, import_react.forwardRef)(({ className, datatype, setValue, onChangeEnd, size, focusable, data, swatchesPerRow, value, ...others }, ref) => {
	const ctx = useColorPickerContext();
	const colors = data.map((color, index) => /* @__PURE__ */ (0, import_react.createElement)(ColorSwatch, {
		...
		tabIndex: focusable ? 0 : -1,
		"data-swatch": true
	}, value === color && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckIcon, {
		size: "35%",
		color: luminance(color) < .5 ? "white" : "black"
	})));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorPicker/ColorPicker.mjs
var defaultProps$67 = {
	swatchesPerRow: 7,
	withPicker: true,
	focusable: true,
...
var varsResolver$47 = createVarsResolver((_, { size, swatchesPerRow }) => ({ wrapper: {
...
var ColorPicker = factory((_props, ref) => {
	const props = useProps("ColorPicker", defaultProps$67, _props);
	const { classNames, className, style, styles, unstyled, vars, format = "hex", value, defaultValue, onChange, onChangeEnd, withPicker, size, saturationLabel, hueLabel, alphaLabel, focusable, swatches, swatchesPerRow, fullWidth, onColorSwatchClick, __staticSelector, mod, attributes, ...others } = props;
	const getStyles = useStyles({
		name: __staticSelector,
		props,
		classes: classes$47,
	...
	const formatRef = (0, import_react.useRef)(format || "hex");
	...
	useDidUpdate(() => {
		if (typeof value === "string" && isColorValid(value) && !isScrubbingRef.current) setParsed(parseColor(value));
	}, [value]);
	useDidUpdate(() => {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorInput/ColorInput.module.css.mjs
var classes$46 = {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorInput/EyeDropperIcon.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ColorInput/ColorInput.mjs
var defaultProps$66 = {
	format: "hex",
	fixOnBlur: true,
	withPreview: true,
...
var varsResolver$46 = createVarsResolver((_, { size }) => ({
...
var ColorInput = factory((_props, ref) => {
	...
	const eyeDropper = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ActionIcon, {
		...
		children: eyeDropperIcon || /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeDropperIcon, { ...getStyles("eyeDropperIcon") })
	});
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Combobox/use-combobox/get-index/get-virtualized-index.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Combobox/use-combobox/use-virtualized-combobox.mjs
function useVirtualizedCombobox({ defaultOpened, opened, onOpenedChange, onDropdownClose, onDropdownOpen, loop = true, totalOptionsCount, isOptionDisabled = () => false, getOptionId, selectedOptionIndex, setSelectedOptionIndex, activeOptionIndex, onSelectedOptionSubmit } = {
	...
	return {
		...
		toggleDropdown,
		selectedOptionIndex,
		getSelectedOptionIndex: (0, import_react.useCallback)(() => selectedOptionIndex, []),
		selectOption,
		selectFirstOption,
		selectActiveOption,
		selectNextOption,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Container/Container.module.css.mjs
var classes$45 = { "root": "m_7485cace" };
//#endregion
//#region node_modules/@mantine/core/esm/components/Container/Container.mjs
var varsResolver$45 = createVarsResolver((_, { size, fluid }) => ({ root: { "--container-size": fluid ? void 0 : getSize(size, "container-size") } }));
...
//#endregion
//#region node_modules/@mantine/core/esm/components/CopyButton/CopyButton.mjs
var defaultProps$65 = { timeout: 1e3 };
function CopyButton(props) {
	const { children, timeout, value, ...others } = useProps("CopyButton", defaultProps$65, props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Dialog/Dialog.module.css.mjs
var classes$44 = {
	"root": "m_e2125a27",
	"closeButton": "m_5abab665"
};
//#endregion
//#region node_modules/@mantine/core/esm/components/Dialog/Dialog.mjs
var defaultProps$64 = {
	shadow: "md",
	p: "md",
	withBorder: false,
...
var varsResolver$44 = createVarsResolver((_, { size }) => ({ root: { "--dialog-size": getSize(size, "dialog-size") } }));
var Dialog = factory((_props, ref) => {
	const props = useProps("Dialog", defaultProps$64, _props);
...
var defaultProps$63 = { orientation: "horizontal" };
var varsResolver$43 = createVarsResolver((theme, { color, variant, size }) => ({ root: {
...
var Divider = factory((_props, ref) => {
	const props = useProps("Divider", defaultProps$63, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Drawer/Drawer.module.css.mjs
var classes$42 = {
	"root": "m_f11b401e",
	"header": "m_5a7c2c9",
	"content": "m_b8a05bbd",
...
var varsResolver$42 = createVarsResolver((_, { position, size, offset }) => ({ root: {
...
var DrawerRoot = factory((_props, ref) => {
	const props = useProps("DrawerRoot", defaultProps$62, _props);
	...
	const drawerTransition = (dir === "rtl" ? rtlTransitions : transitions$1)[position];
...
var Drawer = factory((_props, ref) => {
	const { title, withOverlay, overlayProps, withCloseButton, closeButtonProps, children, opened, stackId, zIndex, ...others } = useProps("Drawer", defaultProps$61, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Fieldset/Fieldset.module.css.mjs
var classes$41 = {
	"root": "m_e9408a47",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Fieldset/Fieldset.mjs
var defaultProps$60 = { variant: "default" };
var varsResolver$41 = createVarsResolver((_, { radius }) => ({ root: { "--fieldset-radius": radius === void 0 ? void 0 : getRadius(radius) } }));
var Fieldset = factory((_props, ref) => {
	const props = useProps("Fieldset", defaultProps$60, _props);
	const { classNames, className, style, styles, unstyled, vars, legend, variant, children, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "Fieldset",
		classes: classes$41,
		props,
...
var defaultProps$59 = { multiple: false };
var FileButton = (0, import_react.forwardRef)((props, ref) => {
	const { onChange, children, multiple, accept, name, form, resetRef, disabled, capture, inputProps, ...others } = useProps("FileButton", defaultProps$59, props);
...
var _FileInput = factory((_props, ref) => {
	const props = useProps("FileInput", defaultProps$58, _props);
	const { unstyled, vars, onChange, value, defaultValue, multiple, accept, name, form, valueComponent: ValueComponent, clearable, clearButtonProps, readOnly, capture, fileInputProps, rightSection, size, placeholder, component, resetRef: resetRefProp, classNames, styles, attributes, ...others } = props;
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Grid/Grid.module.css.mjs
var classes$40 = {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Grid/GridCol/GridColVariables.mjs
...
function GridColVariables({ span, order, offset, selector }) {
	...
	const baseSpan = getBaseValue(span) === void 0 ? 12 : getBaseValue(span);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Grid/GridCol/GridCol.mjs
var defaultProps$57 = { span: 12 };
var GridCol = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, span, order, offset, ...others } = useProps("GridCol", defaultProps$57, _props);
	const ctx = useGridContext();
	const responsiveClassName = useRandomClassName();
...
var varsResolver$40 = createVarsResolver((_, { justify, align, overflow }) => ({ root: {
	"--grid-justify": justify,
	"--grid-align": align,
	"--grid-overflow": overflow
} }));
var Grid = factory((_props, ref) => {
	const props = useProps("Grid", defaultProps$56, _props);
...
Grid.Col = GridCol;
//#endregion
//#region node_modules/@mantine/core/esm/components/Mark/get-mark-color.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Mark/Mark.module.css.mjs
var classes$39 = { "root": "m_bcb3f3c2" };
//#endregion
//#region node_modules/@mantine/core/esm/components/Mark/Mark.mjs
var defaultProps$55 = { color: "yellow" };
var varsResolver$39 = createVarsResolver((theme, { color }) => ({ root: {
...
var Mark = factory((_props, ref) => {
	const props = useProps("Mark", defaultProps$55, _props);
	const { classNames, className, style, styles, unstyled, vars, color, variant, attributes, ...others } = props;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		component: "mark",
		ref,
		variant,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Highlight/highlighter/highlighter.mjs
...
function highlighter(value, _highlight) {
	...
	return value.split(re).map((part) => ({
		chunk: part,
		highlighted: re.test(part)
	})).filter(({ chunk }) => chunk);
}
//#endregion
//#region node_modules/@mantine/core/esm/components/Highlight/Highlight.mjs
var Highlight = polymorphicFactory((props, ref) => {
	const { unstyled, children, highlight, highlightStyles, color, ...others } = useProps("Highlight", null, props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/HoverCard/HoverCard.context.mjs
var [HoverCardContextProvider, useHoverCardContext] = createSafeContext("HoverCard component was not found in the tree");
//#endregion
//#region node_modules/@mantine/core/esm/components/HoverCard/HoverCardGroup/HoverCardGroup.context.mjs
var HoverCardGroupContext = (0, import_react.createContext)(false);
var HoverCardGroupProvider = HoverCardGroupContext.Provider;
var useHoverCardGroupContext = () => (0, import_react.useContext)(HoverCardGroupContext);
//#endregion
//#region node_modules/@mantine/core/esm/components/HoverCard/HoverCardDropdown/HoverCardDropdown.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/HoverCard/HoverCardGroup/HoverCardGroup.mjs
var defaultProps$54 = {
	openDelay: 0,
	closeDelay: 0
};
function HoverCardGroup(props) {
	const { openDelay, closeDelay, children } = useProps("HoverCardGroup", defaultProps$54, props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HoverCardGroupProvider, {
		value: true,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/HoverCard/HoverCardTarget/HoverCardTarget.mjs
var defaultProps$53 = { refProp: "ref" };
var HoverCardTarget = (0, import_react.forwardRef)((props, ref) => {
	const { children, refProp, eventPropsWrapperName, ...others } = useProps("HoverCardTarget", defaultProps$53, props);
	const child = getSingleElementChild(children);
	...
	if (useHoverCardGroupContext() && ctx.getReferenceProps && ctx.reference) {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Popover.Target, {
			...
			ref,
			...others,
			children: (0, import_react.cloneElement)(child, eventPropsWrapperName ? { [eventPropsWrapperName]: {
				...referenceProps,
				ref: ctx.reference
			} } : {
				...referenceProps,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Popover.Target, {
		...
		ref,
		...others,
		children: (0, import_react.cloneElement)(child, eventPropsWrapperName ? { [eventPropsWrapperName]: eventListeners } : eventListeners)
	});
});
HoverCardTarget.displayName = "@mantine/core/HoverCardTarget";
//#endregion
//#region node_modules/@mantine/core/esm/components/HoverCard/use-hover-card.mjs
function useHoverCard(settings) {
	...
	const openDropdown = (0, import_react.useCallback)(() => {
	...
	(0, import_react.useEffect)(() => () => clearTimeouts(), [clearTimeouts]);
	return {
		opened,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/HoverCard/HoverCard.mjs
var defaultProps$52 = {
	openDelay: 0,
	closeDelay: 150,
...
function HoverCard(props) {
	const { children, onOpen, onClose, openDelay, closeDelay, initiallyOpened, ...others } = useProps("HoverCard", defaultProps$52, props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Image/Image.module.css.mjs
var classes$38 = { "root": "m_9e117634" };
//#endregion
//#region node_modules/@mantine/core/esm/components/Image/Image.mjs
var varsResolver$38 = createVarsResolver((_, { radius, fit }) => ({ root: {
...
var Image = polymorphicFactory((_props, ref) => {
	...
	const { classNames, className, style, styles, unstyled, vars, onError, src, radius, fit, fallbackSrc, mod, attributes, ...others } = props;
	const [error, setError] = (0, import_react.useState)(!src);
	(0, import_react.useEffect)(() => setError(!src), [src]);
	const getStyles = useStyles({
		name: "Image",
	...
	if (error && fallbackSrc) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		component: "img",
		ref,
		src: fallbackSrc,
		...getStyles("root"),
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Indicator/get-position-variables/get-position-variables.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Indicator/Indicator.module.css.mjs
var classes$37 = {
	"root": "m_e5262200",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Indicator/Indicator.mjs
var defaultProps$51 = {
	position: "top-end",
	offset: 0
};
var varsResolver$37 = createVarsResolver((theme, { color, position, offset, size, radius, zIndex, autoContrast }) => ({ root: {
...
var Indicator = factory((_props, ref) => {
	const props = useProps("Indicator", defaultProps$51, _props);
...
//#endregion
//#region node_modules/react-textarea-autosize/dist/react-textarea-autosize.browser.development.esm.js
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Textarea/Textarea.mjs
var defaultProps$50 = { size: "sm" };
var Textarea = factory((props, ref) => {
	const { autosize, maxRows, minRows, __staticSelector, resize, ...others } = useProps("Textarea", defaultProps$50, props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/JsonInput/validate-json/validate-json.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/JsonInput/JsonInput.mjs
var defaultProps$49 = {
...
var JsonInput = factory((props, ref) => {
	const { value, defaultValue, onChange, formatOnBlur, validationError, serialize, deserialize, onFocus, onBlur, readOnly, error, ...others } = useProps("JsonInput", defaultProps$49, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: "",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Kbd/Kbd.module.css.mjs
var classes$36 = { "root": "m_dc6f14e2" };
//#endregion
//#region node_modules/@mantine/core/esm/components/Kbd/Kbd.mjs
var varsResolver$36 = createVarsResolver((_, { size }) => ({ root: { "--kbd-fz": getSize(size, "kbd-fz") } }));
...
//#endregion
//#region node_modules/@mantine/core/esm/components/List/List.context.mjs
var [ListProvider, useListContext] = createSafeContext("List component was not found in tree");
//#endregion
//#region node_modules/@mantine/core/esm/components/List/List.module.css.mjs
var classes$35 = {
	"root": "m_abbac491",
	"item": "m_abb6bec2",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/List/ListItem/ListItem.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/List/List.mjs
var defaultProps$48 = { type: "unordered" };
var varsResolver$35 = createVarsResolver((_, { size, spacing }) => ({ root: {
	"--list-fz": getFontSize(size),
	"--list-lh": getLineHeight(size),
	"--list-spacing": getSpacing(spacing)
} }));
var List = factory((_props, ref) => {
	const props = useProps("List", defaultProps$48, _props);
	const { classNames, className, style, styles, unstyled, vars, children, type, withPadding, icon, spacing, center, listStyleType, mod, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "List",
		classes: classes$35,
		props,
...
List.Item = ListItem;
//#endregion
//#region node_modules/@mantine/core/esm/components/LoadingOverlay/LoadingOverlay.module.css.mjs
var classes$34 = {
	"root": "m_6e45937b",
	"loader": "m_e8eb006c",
	"overlay": "m_df587f17"
...
//#endregion
//#region node_modules/@mantine/core/esm/components/LoadingOverlay/LoadingOverlay.mjs
var defaultProps$47 = {
	transitionProps: {
		transition: "fade",
		duration: 0
...
var varsResolver$34 = createVarsResolver((_, { zIndex }) => ({ root: { "--lo-z-index": zIndex?.toString() } }));
var LoadingOverlay = factory((_props, ref) => {
	const props = useProps("LoadingOverlay", defaultProps$47, _props);
	const { classNames, className, style, styles, unstyled, vars, transitionProps, loaderProps, overlayProps, visible, zIndex, attributes, ...others } = props;
	const theme = useMantineTheme();
	const getStyles = useStyles({
		name: "LoadingOverlay",
		classes: classes$34,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Menu/Menu.module.css.mjs
var classes$33 = {
	"dropdown": "m_dc9b7c9f",
	"label": "m_9bfac126",
	"divider": "m_efdf90cb",
...
var MenuDropdown = factory((props, ref) => {
	const { classNames, className, style, styles, vars, onMouseEnter, onMouseLeave, onKeyDown, children, ...others } = useProps("MenuDropdown", null, props);
...
var MenuItem = polymorphicFactory((props, ref) => {
	const { classNames, className, style, styles, vars, color, closeMenuOnClick, leftSection, rightSection, children, disabled, "data-disabled": dataDisabled, ...others } = useProps("MenuItem", null, props);
	const ctx = useMenuContext();
...
var MenuSubDropdown = factory((props, ref) => {
	const { classNames, className, style, styles, vars, onMouseEnter, onMouseLeave, onKeyDown, children, ...others } = useProps("MenuSubDropdown", null, props);
	const wrapperRef = (0, import_react.useRef)(null);
	const ctx = useMenuContext();
	const subCtx = useSubMenuContext();
...
var MenuSubItem = polymorphicFactory((props, ref) => {
	const { classNames, className, style, styles, vars, color, leftSection, rightSection, children, disabled, "data-disabled": dataDisabled, closeMenuOnClick, ...others } = useProps("MenuSubItem", null, props);
	const ctx = useMenuContext();
	const subCtx = useSubMenuContext();
	const theme = useMantineTheme();
	const { dir } = useDirection();
...
function MenuSub(_props) {
	const { children, closeDelay, openDelay, ...others } = useProps("MenuSub", defaultProps$46, _props);
	const id = useId$3();
...
var defaultProps$45 = { refProp: "ref" };
var MenuTarget = (0, import_react.forwardRef)((props, ref) => {
	const { children, refProp, ...others } = useProps("MenuTarget", defaultProps$45, props);
	const child = getSingleElementChild(children);
...
function Menu(_props) {
	const props = useProps("Menu", defaultProps$44, _props);
...
Menu.Sub = MenuSub;
//#endregion
//#region node_modules/@mantine/core/esm/components/Modal/Modal.module.css.mjs
var classes$32 = {
	"root": "m_9df02822",
	"content": "m_54c44539",
	"inner": "m_1f958f16",
...
var varsResolver$33 = createVarsResolver((_, { radius, size, yOffset, xOffset }) => ({ root: {
...
var ModalRoot = factory((_props, ref) => {
	const props = useProps("ModalRoot", defaultProps$43, _props);
...
var Modal = factory((_props, ref) => {
	const { title, withOverlay, overlayProps, withCloseButton, closeButtonProps, children, radius, opened, stackId, zIndex, ...others } = useProps("Modal", defaultProps$42, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Modal/use-modals-stack.mjs
function useModalsStack(modals) {
	...
	return {
		...
		open,
		close,
		closeAll: (0, import_react.useCallback)(() => setState(initialState), []),
		toggle,
		register: (0, import_react.useCallback)((modal) => ({
			opened: state[modal],
			onClose: () => close(modal),
			stackId: modal
		}), [state])
...
//#endregion
//#region node_modules/@mantine/core/esm/components/PillsInput/PillsInput.context.mjs
var [PillsInputProvider, usePillsInputContext] = createOptionalContext();
//#endregion
//#region node_modules/@mantine/core/esm/components/Pill/Pill.module.css.mjs
var classes$31 = {
	"root": "m_7cda1cd6",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Pill/PillGroup.context.mjs
var [PillGroupProvider, usePillGroupContext] = createOptionalContext();
//#endregion
//#region node_modules/@mantine/core/esm/components/Pill/PillGroup/PillGroup.mjs
var varsResolver$32 = createVarsResolver((_, { gap }, { size }) => ({ group: { "--pg-gap": gap !== void 0 ? getSize(gap) : getSize(size, "pg-gap") } }));
var PillGroup = factory((_props, ref) => {
	...
	const _size = usePillsInputContext()?.size || size || void 0;
	const getStyles = useStyles({
		name: "PillGroup",
		classes: classes$31,
		props,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Pill/Pill.mjs
var defaultProps$41 = { variant: "default" };
var varsResolver$31 = createVarsResolver((_, { radius }, { size }) => ({ root: {
...
var Pill = factory((_props, ref) => {
	const props = useProps("Pill", defaultProps$41, _props);
	const { classNames, className, style, styles, unstyled, vars, variant, children, withRemoveButton, onRemove, removeButtonProps, radius, size, disabled, mod, attributes, ...others } = props;
...
//#endregion
//#region node_modules/@mantine/core/esm/components/PillsInput/PillsInput.module.css.mjs
var classes$30 = { "field": "m_45c4369d" };
//#endregion
//#region node_modules/@mantine/core/esm/components/PillsInput/PillsInputField/PillsInputField.mjs
var defaultProps$40 = { type: "visible" };
var PillsInputField = factory((_props, ref) => {
	const props = useProps("PillsInputField", defaultProps$40, _props);
	const { classNames, className, style, styles, unstyled, vars, type, disabled, id, pointer, mod, attributes, ...others } = props;
...
//#endregion
//#region node_modules/@mantine/core/esm/components/PillsInput/PillsInput.mjs
var defaultProps$39 = { size: "sm" };
var PillsInput = factory((_props, ref) => {
	const { children, onMouseDown, onClick, size, disabled, __staticSelector, error, variant, ...others } = useProps("PillsInput", defaultProps$39, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/MultiSelect/filter-picked-values.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/MultiSelect/MultiSelect.mjs
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Combobox, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Combobox.DropdownTarget, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PillsInput, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Pill.Group, {
				...
				children: [values, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Combobox.EventsTarget, {
					autoComplete,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/NativeSelect/NativeSelectOption.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/NativeSelect/NativeSelect.mjs
var defaultProps$37 = { rightSectionPointerEvents: "none" };
var NativeSelect = factory((props, ref) => {
	const { data, children, size, error, rightSection, unstyled, ...others } = useProps("NativeSelect", defaultProps$37, props);
	const options = getParsedComboboxData(data).map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NativeSelectOption, { data: item }, index));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InputBase, {
		component: "select",
		ref,
		...others,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/NavLink/NavLink.module.css.mjs
var classes$29 = {
	"root": "m_f0824112",
...
var varsResolver$30 = createVarsResolver((theme, { variant, color, childrenOffset, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		variant: variant || "light",
...
var NavLink = polymorphicFactory((_props, ref) => {
	...
	const { classNames, className, style, styles, unstyled, vars, opened, defaultOpened, onChange, children, active, disabled, leftSection, rightSection, label, description, disableRightSectionRotation, noWrap, childrenOffset, autoContrast, mod, attributes, onClick, onKeyDown, ...others } = props;
	const getStyles = useStyles({
		name: "NavLink",
		props,
		classes: classes$29,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Notification/Notification.module.css.mjs
var classes$28 = {
	"root": "m_a513464",
	"icon": "m_a4ceffb",
	"loader": "m_b0920b15",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Notification/Notification.mjs
var defaultProps$36 = { withCloseButton: true };
var varsResolver$29 = createVarsResolver((theme, { radius, color }) => ({ root: {
...
var Notification = factory((_props, ref) => {
	const props = useProps("Notification", defaultProps$36, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/NumberFormatter/NumberFormatter.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/NumberInput/NumberInput.module.css.mjs
var classes$27 = {
	"root": "m_e2f5cd4e",
	"controls": "m_95e17d22",
	"control": "m_80b4b171"
...
var varsResolver$28 = createVarsResolver((_, { size }) => ({ controls: { "--ni-chevron-size": getSize(size, "ni-chevron-size") } }));
...
var NumberInput = factory((_props, ref) => {
	...
	const handleValueChange = (payload, event) => {
		if (event.source === "event") setValue(isValidNumber(payload.floatValue, payload.value) && !leadingDecimalZeroPattern.test(payload.value) && !(allowLeadingZeros ? leadingZerosPattern.test(payload.value) : false) && !trailingZerosPattern.test(payload.value) && !trailingDecimalSeparatorPattern.test(payload.value) ? payload.floatValue : payload.value);
	...
	incrementRef.current = () => {
		...
		if (!isNumberString(_value) && (typeof _value !== "number" || Number.isNaN(_value))) val = clamp$3(startValue, min, max);
		else if (max !== void 0) {
	...
	decrementRef.current = () => {
		...
		const maxPrecision = Math.max(currentValuePrecision, stepPrecision);
		const factor = 10 ** maxPrecision;
		if (!isNumberString(_value) && typeof _value !== "number" || Number.isNaN(_value)) val = clamp$3(startValue, minValue, max);
		else {
	...
	const handleBlur = (event) => {
		...
		if (clampBehavior === "blur" && typeof sanitizedValue === "number") sanitizedValue = clamp$3(sanitizedValue, min, max);
		if (trimLeadingZeroesOnBlur && typeof sanitizedValue === "string" && getDecimalPlaces2(sanitizedValue) < 15) sanitizedValue = clampAndSanitizeInput(sanitizedValue, max, min);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InputBase, {
		...
		allowNegative,
		className: clsx(classes$27.root, className),
		size,
		inputMode: "decimal",
		...others,
		readOnly,
		...
		isAllowed: (val) => {
			if (clampBehavior === "strict") {
				if (isAllowed) return isAllowed(val) && isInRange(val.floatValue, min, max);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Pagination/Pagination.module.css.mjs
var classes$26 = {
	"root": "m_4addd315",
	"control": "m_326d024a",
	"dots": "m_4ad7767d"
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Pagination/Pagination.context.mjs
var [PaginationProvider, usePaginationContext] = createSafeContext("Pagination.Root component was not found in tree");
//#endregion
//#region node_modules/@mantine/core/esm/components/Pagination/PaginationControl/PaginationControl.mjs
var defaultProps$34 = { withPadding: true };
var PaginationControl = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, active, disabled, withPadding, mod, ...others } = useProps("PaginationControl", defaultProps$34, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Pagination/Pagination.icons.mjs
...
var PaginationNextIcon = (props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaginationIcon, {
	...props,
	path: "M8.781 8l-3.3-3.3.943-.943L10.667 8l-4.243 4.243-.943-.943 3.3-3.3z"
});
var PaginationPreviousIcon = (props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaginationIcon, {
	...props,
	path: "M7.219 8l3.3 3.3-.943.943L5.333 8l4.243-4.243.943.943-3.3 3.3z"
});
var PaginationFirstIcon = (props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaginationIcon, {
	...props,
...
var PaginationLastIcon = (props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaginationIcon, {
	...props,
...
var PaginationDotsIcon = (props) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaginationIcon, {
	...props,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Pagination/PaginationDots/PaginationDots.mjs
var defaultProps$33 = { icon: PaginationDotsIcon };
var PaginationDots = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, icon: Icon, ...others } = useProps("PaginationDots", defaultProps$33, _props);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		ref,
		...usePaginationContext().getStyles("dots", {
			className,
			style,
			styles,
			classNames
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Pagination/PaginationEdges/PaginationEdges.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Pagination/PaginationItems/PaginationItems.mjs
function PaginationItems({ dotsIcon }) {
	const ctx = usePaginationContext();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: ctx.range.map((page, index) => {
		if (page === "dots") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaginationDots, { icon: dotsIcon }, index);
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaginationControl, {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Pagination/PaginationRoot/PaginationRoot.mjs
var defaultProps$32 = {
	siblings: 1,
	boundaries: 1
};
var varsResolver$27 = createVarsResolver((theme, { size, radius, color, autoContrast }) => ({ root: {
...
var PaginationRoot = factory((_props, ref) => {
	const props = useProps("PaginationRoot", defaultProps$32, _props);
	const { classNames, className, style, styles, unstyled, vars, total, value, defaultValue, onChange, disabled, siblings, boundaries, color, radius, onNextPage, onPreviousPage, onFirstPage, onLastPage, getItemProps, autoContrast, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "Pagination",
		classes: classes$26,
		props,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Pagination/Pagination.mjs
var defaultProps$31 = {
	withControls: true,
	withPages: true,
	siblings: 1,
...
var Pagination = factory((_props, ref) => {
	const { withEdges, withControls, getControlProps, nextIcon, previousIcon, lastIcon, firstIcon, dotsIcon, total, gap, hideWithOnePage, withPages, ...others } = useProps("Pagination", defaultProps$31, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/PasswordInput/PasswordInput.module.css.mjs
var classes$25 = {
	"root": "m_f61ca620",
	"input": "m_ccf8da4c",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/PasswordInput/PasswordToggleIcon.mjs
var PasswordToggleIcon = ({ reveal }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	viewBox: "0 0 15 15",
	fill: "none",
	xmlns: "http://www.w3.org/2000/svg",
	style: {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/PasswordInput/PasswordInput.mjs
var defaultProps$30 = { visibilityToggleIcon: PasswordToggleIcon };
var varsResolver$26 = createVarsResolver((_, { size }) => ({ root: {
	"--psi-icon-size": getSize(size, "psi-icon-size"),
	"--psi-button-size": getSize(size, "psi-button-size")
} }));
var PasswordInput = factory((_props, ref) => {
	const props = useProps("PasswordInput", defaultProps$30, _props);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input.Wrapper, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
			...
			classNames: {
				...resolvedClassNames,
				input: clsx(classes$25.input, resolvedClassNames.input)
			},
			styles: resolvedStyles,
			radius,
			disabled,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/PinInput/PinInput.module.css.mjs
var classes$24 = {
	"root": "m_f1cb205a",
	"pinInput": "m_cb288ead"
};
...
var varsResolver$25 = createVarsResolver((_, { size }) => ({ root: { "--pin-input-size": getSize(size ?? "sm", "pin-input-size") } }));
var PinInput = factory((props, ref) => {
	const { name, form, className, value, defaultValue, variant, gap, style, size, classNames, styles, unstyled, length, onChange, onComplete, manageFocus, autoFocus, error, radius, disabled, oneTimeCode, placeholder, type, mask, readOnly, inputType, inputMode, ariaLabel, vars, id, hiddenInputProps, rootRef, getInputProps, attributes, ...others } = useProps("PinInput", defaultProps$29, props);
	const uuid = useId$3(id);
	const getStyles = useStyles({
		name: "PinInput",
		classes: classes$24,
	...
	const handleKeyDown = (event, index) => {
		...
		if (inputMode === "numeric") {
			if (!(key === "Backspace" || key === "Tab" || key === "Control" || key === "Delete" || ctrlKey && key === "v" || metaKey && key === "v" ? true : !Number.isNaN(Number(key)))) event.preventDefault();
		}
		if (key === "ArrowLeft" || shiftKey && key === "Tab") focusInputField("prev", index, event);
		else if (key === "ArrowRight" || key === "Tab" || key === " ") focusInputField("next", index, event);
		else if (key === "Delete") setFieldValue("", index);
		else if (key === "Backspace") {
			if (index !== 0) {
				setFieldValue("", index);
				if (length === index + 1) {
					if (event.target.value === "") focusInputField("prev", index, event);
				} else focusInputField("prev", index, event);
			}
		} else if (inputValue.length > 0 && key === _value[index]) focusInputField("next", index, event);
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Group, {
		...
		__size: size,
		dir: "ltr",
		children: _value.map((char, index) => /* @__PURE__ */ (0, import_react.createElement)(Input, {
			component: "input",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Progress/Progress.module.css.mjs
var classes$23 = {
	"root": "m_db6d6462",
	"section": "m_2242eb65",
...
var varsResolver$24 = createVarsResolver((_, { size, radius, transitionDuration }) => ({ root: {
...
var defaultProps$28 = { withAria: true };
var ProgressSection = factory((props, ref) => {
	const { classNames, className, style, styles, vars, value, withAria, color, striped, animated, mod, ...others } = useProps("ProgressSection", defaultProps$28, props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Radio/Radio.module.css.mjs
var classes$22 = {
	"root": "m_f3f1af94",
	"inner": "m_89c4f5e4",
	"icon": "m_f3ed6b2b",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Radio/RadioGroup.context.mjs
var [RadioGroupProvider, useRadioGroupContext] = createOptionalContext();
//#endregion
//#region node_modules/@mantine/core/esm/components/Radio/RadioCard/RadioCard.context.mjs
var [RadioCardProvider, useRadioCardContext] = createOptionalContext();
//#endregion
//#region node_modules/@mantine/core/esm/components/Radio/RadioCard/RadioCard.module.css.mjs
var classes$21 = { "card": "m_9dc8ae12" };
//#endregion
//#region node_modules/@mantine/core/esm/components/Radio/RadioCard/RadioCard.mjs
var defaultProps$27 = { withBorder: true };
var varsResolver$23 = createVarsResolver((_, { radius }) => ({ card: { "--card-radius": getRadius(radius) } }));
var RadioCard = factory((_props, ref) => {
	const props = useProps("RadioCard", defaultProps$27, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Radio/RadioIndicator/RadioIndicator.module.css.mjs
var classes$20 = {
...
var defaultProps$26 = { icon: RadioIcon };
var varsResolver$22 = createVarsResolver((theme, { radius, color, size, iconColor, variant, autoContrast }) => {
	const parsedColor = parseThemeColor({
		color: color || theme.primaryColor,
		theme
	});
...
var RadioIndicator = factory((_props, ref) => {
	const props = useProps("RadioIndicator", defaultProps$26, _props);
...
RadioIndicator.classes = classes$20;
//#endregion
//#region node_modules/@mantine/core/esm/components/Radio/Radio.mjs
var defaultProps$25 = { labelPosition: "right" };
var varsResolver$21 = createVarsResolver((theme, { size, radius, color, iconColor, variant, autoContrast }) => {
	const parsedColor = parseThemeColor({
		color: color || theme.primaryColor,
		theme
	});
...
var Radio = factory((_props, ref) => {
	const props = useProps("Radio", defaultProps$25, _props);
	const { classNames, className, style, styles, unstyled, vars, id, size, label, labelPosition, description, error, radius, color, variant, disabled, wrapperProps, icon: Icon = RadioIcon, rootRef, iconColor, onChange, mod, attributes, checked, ...others } = props;
	const getStyles = useStyles({
		name: "Radio",
		classes: classes$22,
		props,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Rating/Rating.module.css.mjs
var classes$19 = {
	"root": "m_f8d312f2",
...
var varsResolver$20 = createVarsResolver((theme, { size, color }) => ({ root: {
	"--rating-size": getSize(size, "rating-size"),
	"--rating-color": getThemeColor(color, theme)
} }));
var Rating = factory((_props, ref) => {
	const props = useProps("Rating", defaultProps$24, _props);
	const { classNames, className, style, styles, unstyled, vars, name, id, value, defaultValue, onChange, fractions, count, onMouseEnter, readOnly, onMouseMove, onHover, onMouseLeave, onTouchStart, onTouchEnd, size, variant, getSymbolLabel, color, emptySymbol, fullSymbol, highlightSelectedOnly, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "Rating",
		classes: classes$19,
		props,
	...
	const getRatingFromCoordinates = (x) => {
		...
		return clamp$3(roundValueTo((dir === "rtl" ? right - x : x - left) / symbolWidth + decimalUnit / 2, decimalUnit), decimalUnit, _count);
	};
...
var varsResolver$19 = createVarsResolver((theme, { radius, color }) => ({ tooltip: {
...
var TooltipFloating = factory((_props, ref) => {
	const props = useProps("TooltipFloating", defaultProps$23, _props);
...
var TooltipGroupContext = (0, import_react.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react.useContext)(TooltipGroupContext);
//#endregion
...
function TooltipGroup(props) {
	const { openDelay, closeDelay, children } = useProps("TooltipGroup", defaultProps$22, props);
...
var varsResolver$18 = createVarsResolver((theme, { radius, color, variant, autoContrast }) => {
	const colors = theme.variantColorResolver({
		theme,
		color: color || theme.primaryColor,
		autoContrast,
...
var Tooltip = factory((_props, ref) => {
	const props = useProps("Tooltip", defaultProps$21, _props);
	const { children, position, refProp, label, openDelay, closeDelay, onPositionChange, opened, defaultOpened, withinPortal, radius, color, classNames, styles, unstyled, style, className, withArrow, arrowSize, arrowOffset, arrowRadius, arrowPosition, offset, transitionProps, multiline, events, zIndex, disabled, positionDependencies, onClick, onMouseEnter, onMouseLeave, inline, variant, keepMounted, vars, portalProps, mod, floatingStrategy, middlewares, autoContrast, attributes, target, ...others } = useProps("Tooltip", defaultProps$21, props);
	const { dir } = useDirection();
	const arrowRef = (0, import_react.useRef)(null);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/RingProgress/Curve/get-curve-props.mjs
function getCurveProps({ size, thickness, sum, value, root, offset }) {
	const radius = (size * .9 - thickness * 2) / 2;
...
//#endregion
//#region node_modules/@mantine/core/esm/components/RingProgress/get-curves/get-curves.mjs
function getCurves({ size, thickness, sections, renderRoundedLineCaps, rootColor }) {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/RingProgress/RingProgress.module.css.mjs
var classes$17 = {
	"root": "m_b32e4812",
	"svg": "m_d43b5134",
	"curve": "m_b1ca1fbf",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/RingProgress/RingProgress.mjs
...
var varsResolver$17 = createVarsResolver((_, { size, thickness, transitionDuration }) => ({ root: {
	"--rp-size": rem(size),
...
var RingProgress = factory((_props, ref) => {
	const props = useProps("RingProgress", defaultProps$20, _props);
	const { classNames, className, style, styles, unstyled, vars, label, sections, size, thickness, roundCaps, rootColor, transitionDuration, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "RingProgress",
		classes: classes$17,
		props,
	...
	const curves = getCurves({
		...
		rootColor
	}).map(({ data, sum, root, lineRoundCaps, offset }, index) => /* @__PURE__ */ (0, import_react.createElement)(Curve, {
		...data,
		key: index,
		size,
		thickness: clampedThickness,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/SegmentedControl/SegmentedControl.module.css.mjs
var classes$16 = {
	"root": "m_cf365364",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/SegmentedControl/SegmentedControl.mjs
var defaultProps$19 = { withItemsBorders: true };
var varsResolver$16 = createVarsResolver((theme, { radius, color, transitionDuration, size, transitionTimingFunction }) => ({ root: {
...
var SegmentedControl = factory((_props, ref) => {
	const props = useProps("SegmentedControl", defaultProps$19, _props);
	const { classNames, className, style, styles, unstyled, vars, data, value, defaultValue, onChange, size, name, disabled, readOnly, fullWidth, orientation, radius, color, transitionDuration, transitionTimingFunction, variant, autoContrast, withItemsBorders, mod, attributes, ...others } = props;
	const getStyles = useStyles({
...
var Select = factory((_props, ref) => {
	const props = useProps("Select", defaultProps$18, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/SemiCircleProgress/SemiCircleProgress.module.css.mjs
var classes$15 = {
	"root": "m_fa528724",
	"svg": "m_62e9e7e2",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/SemiCircleProgress/SemiCircleProgress.mjs
var defaultProps$17 = {
	size: 200,
	thickness: 12,
	orientation: "up",
...
var varsResolver$15 = createVarsResolver((theme, { filledSegmentColor, emptySegmentColor, orientation, fillDirection, transitionDuration, thickness }) => ({ root: {
...
var SemiCircleProgress = factory((_props, ref) => {
	const props = useProps("SemiCircleProgress", defaultProps$17, _props);
	const { classNames, className, style, styles, unstyled, vars, size, thickness, value, orientation, fillDirection, filledSegmentColor, emptySegmentColor, transitionDuration, label, labelPosition, attributes, ...others } = props;
	const getStyles = useStyles({
	...
	const semiCirclePercentage = clamp$3(value, 0, 100) * (circumference / 100);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Box, {
		ref,
		size,
		...getStyles("root"),
...
//#endregion
//#region node_modules/@mantine/core/esm/components/SimpleGrid/SimpleGrid.module.css.mjs
var classes$14 = {
...
var SimpleGrid = factory((_props, ref) => {
	const props = useProps("SimpleGrid", defaultProps$16, _props);
...
var varsResolver$14 = createVarsResolver((_, { width, height, radius, circle }) => ({ root: {
...
var Skeleton = factory((_props, ref) => {
	const props = useProps("Skeleton", defaultProps$15, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Slider/Slider.module.css.mjs
var classes$12 = {
	"root": "m_dd36362e",
	"label": "m_c9357328",
	"thumb": "m_c9a9a60a",
...
var SliderRoot = (0, import_react.forwardRef)(({ size, disabled, variant, color, thumbSize, radius, ...others }, ref) => {
...
var Thumb = (0, import_react.forwardRef)(({ max, min, value, position, label, dragging, onMouseDown, onKeyDownCapture, labelTransitionProps, labelAlwaysOn, thumbLabel, onFocus, onBlur, showLabelOnHover, isHovered, children = null, disabled }, ref) => {
	const { getStyles } = useSliderContext();
...
function Marks({ marks, min, max, disabled, value, offset, inverted }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: marks.map((mark, index) => /* @__PURE__ */ (0, import_react.createElement)(Box, {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Slider/utils/get-floating-value/get-gloating-value.mjs
...
var varsResolver$13 = createVarsResolver((theme, { size, color, thumbSize, radius }) => ({ root: {
...
var Slider = factory((_props, ref) => {
	const props = useProps("Slider", defaultProps$14, _props);
	const { classNames, styles, value, onChange, onChangeEnd, size, min, max, domain, step, precision: _precision, defaultValue, name, marks, label, labelTransitionProps, labelAlwaysOn, thumbLabel, showLabelOnHover, thumbChildren, disabled, unstyled, scale, inverted, className, style, vars, hiddenInputProps, restrictToMarks, thumbProps, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "Slider",
		props,
		classes: classes$12,
	...
	const { ref: container, active } = useMove((0, import_react.useCallback)(({ x }) => {
		if (!disabled) {
			const clampedValue = clamp$3(getChangeValue({
				value: x,
				min: domainMin,
				max: domainMax,
				step,
		...
		marks,
		restrictToMarks
	]), { onScrubEnd: (0, import_react.useCallback)(() => {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Slider/utils/get-client-position/get-client-position.mjs
function getClientPosition(event) {
	if ("TouchEvent" in window && event instanceof window.TouchEvent) return event.touches[0].clientX;
	return event.clientX;
}
//#endregion
//#region node_modules/@mantine/core/esm/components/Slider/RangeSlider/RangeSlider.mjs
var varsResolver$12 = createVarsResolver((theme, { size, color, thumbSize, radius }) => ({ root: {
	"--slider-size": getSize(size, "slider-size"),
	"--slider-color": color ? getThemeColor(color, theme) : void 0,
	"--slider-radius": radius === void 0 ? void 0 : getRadius(radius),
	"--slider-thumb-size": thumbSize !== void 0 ? rem(thumbSize) : "calc(var(--slider-size) * 2)"
...
var RangeSlider = factory((_props, ref) => {
	const props = useProps("RangeSlider", defaultProps$13, _props);
	const { classNames, styles, value, onChange, onChangeEnd, size, min, max, domain, minRange, maxRange, step, precision: _precision, defaultValue, name, marks, label, labelTransitionProps, labelAlwaysOn, thumbFromLabel, thumbToLabel, showLabelOnHover, thumbChildren, disabled, unstyled, scale, inverted, className, style, vars, hiddenInputProps, restrictToMarks, thumbProps, pushOnOverlap, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "RangeSlider",
		props,
		classes: classes$12,
	...
	const setRangedValue = (val, index, triggerChangeEnd) => {
		...
		if (restrictToMarks && marks) {
			...
			const clampedVal = clamp$3(val, min, max);
	...
	const { ref: useMoveRef, active } = useMove(({ x }) => handleChange(x), { onScrubEnd: () => !disabled && onChangeEnd?.(valueRef.current) }, dir);
	...
	const handleTrackMouseDownCapture = (event) => {
		if (containerRef.current) {
			...
			const changeValue = getChangeValue({
				value: getClientPosition(event.nativeEvent) - rect.left,
				max,
				min,
				step,
			...
			thumbIndex.current = dir === "ltr" ? nearestHandle : nearestHandle === 1 ? 0 : 1;
		}
	};
	...
	const handleTrackKeydownCapture = (event) => {
		if (!disabled) switch (event.key) {
			case "ArrowUp": {
				...
				setRangedValue(getFloatingValue(restrictToMarks && marks ? getNextMarkValue(valueRef.current[focusedIndex], marks) : Math.min(Math.max(valueRef.current[focusedIndex] + step, min), max), precision), focusedIndex, true);
				break;
			}
			case "ArrowRight": {
				event.preventDefault();
				const focusedIndex = getFocusedThumbIndex();
				thumbs.current[focusedIndex].focus();
				setRangedValue(getFloatingValue(restrictToMarks && marks ? (dir === "rtl" ? getPreviousMarkValue : getNextMarkValue)(valueRef.current[focusedIndex], marks) : Math.min(Math.max(dir === "rtl" ? valueRef.current[focusedIndex] - step : valueRef.current[focusedIndex] + step, min), max), precision), focusedIndex, true);
				break;
			}
			case "ArrowDown": {
				event.preventDefault();
				const focusedIndex = getFocusedThumbIndex();
				thumbs.current[focusedIndex].focus();
				setRangedValue(getFloatingValue(restrictToMarks && marks ? getPreviousMarkValue(valueRef.current[focusedIndex], marks) : Math.min(Math.max(valueRef.current[focusedIndex] - step, min), max), precision), focusedIndex, true);
				break;
			}
			case "ArrowLeft": {
				event.preventDefault();
				const focusedIndex = getFocusedThumbIndex();
				thumbs.current[focusedIndex].focus();
				setRangedValue(getFloatingValue(restrictToMarks && marks ? (dir === "rtl" ? getNextMarkValue : getPreviousMarkValue)(valueRef.current[focusedIndex], marks) : Math.min(Math.max(dir === "rtl" ? valueRef.current[focusedIndex] + step : valueRef.current[focusedIndex] - step, min), max), precision), focusedIndex, true);
				break;
			}
		}
	};
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Space/Space.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Spoiler/Spoiler.module.css.mjs
var classes$11 = {
	"root": "m_559cce2d",
	"content": "m_b912df4e",
	"control": "m_b9131032"
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Spoiler/Spoiler.mjs
var defaultProps$12 = {
	maxHeight: 100,
	initialState: false
};
var varsResolver$11 = createVarsResolver((_, { transitionDuration }) => ({ root: { "--spoiler-transition-duration": transitionDuration !== void 0 ? `${transitionDuration}ms` : void 0 } }));
var Spoiler = factory((_props, ref) => {
	const props = useProps("Spoiler", defaultProps$12, _props);
	const { classNames, className, style, styles, unstyled, vars, initialState, maxHeight, hideLabel, showLabel, children, controlRef, transitionDuration, id, expanded, onExpandedChange, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "Spoiler",
		classes: classes$11,
		props,
...
var varsResolver$10 = createVarsResolver((_, { gap, align, justify }) => ({ root: {
	"--stack-gap": getSpacing(gap),
	"--stack-align": align,
	"--stack-justify": justify
} }));
var Stack = factory((_props, ref) => {
	const props = useProps("Stack", defaultProps$11, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Stepper/Stepper.context.mjs
var [StepperProvider, useStepperContext] = createSafeContext("Stepper component was not found in tree");
//#endregion
//#region node_modules/@mantine/core/esm/components/Stepper/Stepper.module.css.mjs
var classes$9 = {
	"root": "m_cbb4ea7e",
	"steps": "m_aaf89d0b",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Stepper/StepperCompleted/StepperCompleted.mjs
var StepperCompleted = () => null;
StepperCompleted.displayName = "@mantine/core/StepperCompleted";
//#endregion
//#region node_modules/@mantine/core/esm/components/Stepper/StepperStep/StepperStep.mjs
var getStepFragment = (Fragment, step) => {
	if (typeof Fragment === "function") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Fragment, { step: step || 0 });
	return Fragment;
};
var defaultProps$10 = {
	withIcon: true,
...
var StepperStep = factory((props, ref) => {
	const { classNames, className, style, styles, vars, step, state, color, icon, completedIcon, progressIcon, label, description, withIcon, iconSize, loading, allowStepClick, allowStepSelect, iconPosition, orientation, mod, ...others } = useProps("StepperStep", defaultProps$10, props);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(UnstyledButton, {
		...
		children: [withIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				}), state !== "stepCompleted" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Loader, {
					...ctx.getStyles("stepLoader", stylesApi),
					size: "calc(var(--stepper-icon-size) / 2)",
					color
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Stepper/Stepper.mjs
var defaultProps$9 = {
	orientation: "horizontal",
	iconPosition: "left",
...
var varsResolver$9 = createVarsResolver((theme, { color, iconSize, size, contentPadding, radius, autoContrast }) => ({ root: {
...
var Stepper = factory((_props, ref) => {
	const props = useProps("Stepper", defaultProps$9, _props);
	const { classNames, className, style, styles, unstyled, vars, children, onStepClick, active, icon, completedIcon, progressIcon, color, iconSize, contentPadding, orientation, iconPosition, size, radius, allowNextStepsSelect, wrap, autoContrast, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "Stepper",
		classes: classes$9,
		props,
	...
	const items = _children.reduce((acc, item, index) => {
		...
		if (orientation === "horizontal" && index !== _children.length - 1) acc.push(/* @__PURE__ */ (0, import_react.createElement)("div", {
			...getStyles("separator"),
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Switch/Switch.module.css.mjs
var classes$8 = {
	"root": "m_5f93f3bb",
	"input": "m_926b4011",
	"track": "m_9307d992",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Switch/SwitchGroup.context.mjs
...
var SwitchGroup = factory((props, ref) => {
	const { value, defaultValue, onChange, size, wrapperProps, children, readOnly, disabled, ...others } = useProps("SwitchGroup", null, props);
	const [_value, setValue] = useUncontrolled({
		value,
		defaultValue,
		finalValue: [],
...
var varsResolver$8 = createVarsResolver((theme, { radius, color, size }) => ({ root: {
...
var Switch = factory((_props, ref) => {
	const props = useProps("Switch", defaultProps$8, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Table/Table.module.css.mjs
var classes$7 = {
	"table": "m_b23fa0ef",
	"th": "m_4e7aa4f3",
	"tr": "m_4e7aa4fd",
...
var defaultProps$7 = { type: "scrollarea" };
var varsResolver$7 = createVarsResolver((_, { minWidth, maxHeight, type }) => ({ scrollContainer: {
...
var TableScrollContainer = factory((_props, ref) => {
	const props = useProps("TableScrollContainer", defaultProps$7, _props);
...
var varsResolver$6 = createVarsResolver((theme, { layout, captionSide, horizontalSpacing, verticalSpacing, borderColor, stripedColor, highlightOnHoverColor, striped, highlightOnHover, stickyHeaderOffset, stickyHeader }) => ({ table: {
	"--table-layout": layout,
...
var Table = factory((_props, ref) => {
	const props = useProps("Table", defaultProps$6, _props);
	const { classNames, className, style, styles, unstyled, vars, horizontalSpacing, verticalSpacing, captionSide, stripedColor, highlightOnHoverColor, striped, highlightOnHover, withColumnBorders, withRowBorders, withTableBorder, borderColor, layout, variant, data, children, stickyHeader, stickyHeaderOffset, mod, tabularNums, attributes, ...others } = props;
	const getStyles = useStyles({
		name: "Table",
		props,
		className,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/TableOfContents/TableOfContents.module.css.mjs
var classes$6 = {
	"root": "m_bcaa9990",
	"control": "m_375a65ef"
};
//#endregion
//#region node_modules/@mantine/core/esm/components/TableOfContents/TableOfContents.mjs
var defaultProps$5 = { getControlProps: ({ data }) => ({ children: data.value }) };
var varsResolver$5 = createVarsResolver((theme, { color, size, variant, autoContrast, depthOffset, radius }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		variant: variant || "filled",
...
var TableOfContents = factory((_props, ref) => {
	const props = useProps("TableOfContents", defaultProps$5, _props);
	const { classNames, className, style, styles, unstyled, vars, color, autoContrast, scrollSpyOptions, initialData, getControlProps, minDepthToOffset, depthOffset, variant, radius, reinitializeRef, attributes, ...others } = props;
	const getStyles = useStyles({
	...
	const idBase = useId$3();
	const spy = useScrollSpy(scrollSpyOptions);
	assignRef(reinitializeRef, spy.reinitialize);
	const controls = (spy.initialized ? spy.data : initialData || []).map((data, index) => {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Tabs/Tabs.module.css.mjs
var classes$5 = {
	"root": "m_89d60db1",
...
var varsResolver$4 = createVarsResolver((theme, { radius, color, autoContrast }) => ({ root: {
...
Tabs.List = TabsList;
//#endregion
//#region node_modules/@mantine/core/esm/components/TagsInput/filter-picked-tags.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/TagsInput/get-splitted-tags.mjs
...
function getSplittedTags({ splitChars, allowDuplicates, maxTags, value, currentTags, isDuplicate, onDuplicate }) {
	const splitted = splitTags(splitChars, value);
	const merged = [];
	if (allowDuplicates) merged.push(...currentTags, ...splitted);
	else {
		merged.push(...currentTags);
		for (const tag of splitted) if ((isDuplicate ? (val) => isDuplicate(val, merged) : (val) => merged.some((t) => t.toLowerCase() === val.toLowerCase()))(tag)) onDuplicate?.(tag);
		else merged.push(tag);
	}
	return maxTags ? merged.slice(0, maxTags) : merged;
}
//#endregion
//#region node_modules/@mantine/core/esm/components/TagsInput/TagsInput.mjs
var defaultProps$3 = {
	maxTags: Infinity,
...
var TagsInput = factory((_props, ref) => {
	...
	const values = _value.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pill, {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/ThemeIcon/ThemeIcon.mjs
var varsResolver$3 = createVarsResolver((theme, { size, radius, variant, gradient, color, autoContrast }) => {
	const colors = theme.variantColorResolver({
		color: color || theme.primaryColor,
		theme,
		gradient,
...
var ThemeIcon = factory((_props, ref) => {
	...
	const { classNames, className, style, styles, unstyled, vars, autoContrast, attributes, ...others } = props;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		ref,
		...useStyles({
			name: "ThemeIcon",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Timeline/Timeline.context.mjs
var [TimelineProvider, useTimelineContext] = createSafeContext("Timeline component was not found in tree");
//#endregion
//#region node_modules/@mantine/core/esm/components/Timeline/Timeline.module.css.mjs
var classes$3 = {
	"root": "m_43657ece",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Timeline/TimelineItem/TimelineItem.mjs
var TimelineItem = factory((_props, ref) => {
	const { classNames, className, style, styles, vars, __active, __align, __lineActive, __vars, bullet, radius, color, lineVariant, children, title, mod, ...others } = useProps("TimelineItem", null, _props);
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Timeline/Timeline.mjs
var defaultProps$2 = {
	active: -1,
	align: "left"
};
var varsResolver$2 = createVarsResolver((theme, { bulletSize, lineWidth, radius, color, autoContrast }) => ({ root: {
...
var Timeline = factory((_props, ref) => {
	const props = useProps("Timeline", defaultProps$2, _props);
	...
	const _children = import_react.Children.toArray(children);
	const items = _children.map((item, index) => (0, import_react.cloneElement)(item, {
		unstyled,
		__align: align,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Title/Title.mjs
var defaultProps$1 = { order: 1 };
var varsResolver$1 = createVarsResolver((_, { order, size, lineClamp, textWrap }) => {
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Tree/Tree.module.css.mjs
var classes$1 = {
	"root": "m_f698e191",
	"subtree": "m_75f3ecf",
	"node": "m_f6970eb1",
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Tree/TreeNode.mjs
...
function TreeNode({ node, getStyles, rootIndex, controller, expandOnClick, selectOnClick, isSubtree, level = 1, renderNode, flatValues, allowRangeSelection, expandOnSpace, checkOnSpace }) {
	const ref = (0, import_react.useRef)(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
		...
		children: [typeof renderNode === "function" ? renderNode({
			...
			...elementProps,
			children: node.label
		}), controller.expandedState[node.value] && nested.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
			component: "ul",
			role: "group",
			...getStyles("subtree"),
			"data-level": level,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Tree/get-all-checked-nodes/get-all-checked-nodes.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Tree/get-children-nodes-values/get-children-nodes-values.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Tree/is-node-checked/is-node-checked.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Tree/is-node-indeterminate/is-node-indeterminate.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Tree/use-tree.mjs
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Tree/Tree.mjs
...
var varsResolver = createVarsResolver((_theme, { levelOffset }) => ({ root: { "--level-offset": getSpacing(levelOffset) } }));
var Tree = factory((_props, ref) => {
	const props = useProps("Tree", defaultProps, _props);
	const { classNames, className, style, styles, unstyled, vars, data, expandOnClick, tree, renderNode, selectOnClick, clearSelectionOnOutsideClick, allowRangeSelection, expandOnSpace, levelOffset, checkOnSpace, attributes, ...others } = props;
	...
	const mergedRef = useMergedRef(ref, useClickOutside(() => clearSelectionOnOutsideClick && controller.clearSelected()));
	const flatValues = (0, import_react.useMemo)(() => getFlatValues(data), [data]);
	(0, import_react.useEffect)(() => {
		controller.initialize(data);
	}, [data]);
	const nodes = data.map((node, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TreeNode, {
		node,
		getStyles,
		rootIndex: index,
		expandOnClick,
...
//#endregion
//#region node_modules/@mantine/core/esm/components/Typography/Typography.module.css.mjs
var classes = { "root": "m_d08caa0" };
//#endregion
//#region node_modules/@mantine/core/esm/components/Typography/Typography.mjs
